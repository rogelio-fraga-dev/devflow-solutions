...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, DevflowLogoComponent, RevealDirective, HeroWaveComponent, TiltDirective],
  ...
  template: `
    ...
    <div class="hero-clone">
      ...
      <div style="position: relative; z-index: 2; display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        <button class="btn-glow-primary" (mousemove)="onMouseMove($event)" (click)="goRegister()">
      ...
      <section id="features" style="padding:100px 40px; border-bottom: 1px solid rgba(255,255,255,0.1); max-width: 1200px; margin: 0 auto;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 60px;">
          @for (f of features; track f.title; let i = $index) {
            <div class="card df-card" appTilt appReveal [revealDelay]="(i % 3) * 90" style="display: flex; flex-direction: column;">
      ...
      <section id="planos" style="padding:100px 40px; border-bottom: 1px solid rgba(255,255,255,0.1); max-width: 1200px; margin: 0 auto;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 40px;">
          @for (p of planos; track p.nome; let i = $index) {
            <div class="card df-card" appTilt appReveal [revealDelay]="i * 100" [style.border]="p.destaque ? '1px solid var(--color_accent_purple)' : '1px solid rgba(255,255,255,.08)'" style="display:flex;flex-direction:column;">
